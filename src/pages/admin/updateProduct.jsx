...
export default function UpdateProductPage() {
    ...
    return (
        <div className="w-full h-full flex justify-center items-center">
            <div className="w-[600px] border-[3px] rounded-[15px] p-10 flex flex-wrap justify-between">
                ...
                <div className="w-[500px] flex flex-col gap-[5px]">
                    ...
                    <textarea
                        ...
                        className="w-full border h-[100px] rounded-md"
                    ></textarea>
                </div>
                <div className="w-[200px] flex flex-col gap-[5px]">
                ...
                <div className="w-full flex justify-center flex-row py-5">
                    <Link
                        to={"/admin/products"}
                        className="w-[200px] h-[50px] bg-white text-black border-2  rounded-md flex justify-center items-center"
                    >
                        Cancel
                    </Link>
                    <button onClick={handleSubmit} className="w-[200px] h-[50px] bg-black text-white border-2 rounded-md flex justify-center items-center ml-5 cursor-pointer">
                        Update Product
                    </button>
                </div>
            </div>
